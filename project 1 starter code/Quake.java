...
public class Quake extends Actioned {
    ...
    public String getQuakeId() { return QUAKE_ID; }
    public int getQuakeActionPeriod() { return QUAKE_ACTION_PERIOD; }
    public int getQuakeAnimationPeriod() { return QUAKE_ANIMATION_PERIOD; }
